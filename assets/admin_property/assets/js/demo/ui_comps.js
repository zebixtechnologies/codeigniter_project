...
;(function( $, window, document, undefined ) {
	...
	var demos = {
		...
		dateTimepicker: function( target ) {
			...
			target.datetimepicker({ ampm: false });
	...
	$(document).ready(function() {
		...
		if( $.fn.timepicker ) {
			...
			demos.dateTimepicker( $( '#timepicker-date1' ) ) ;
			demos.dateTimepicker( $( '#timepicker-date2' ) ) ;
			demos.dateTimepicker( $( '#timepicker-date3' ) ) ;
			demos.dateTimepicker( $( '#timepicker-date4' ) ) ;
		}
