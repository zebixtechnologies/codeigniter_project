...
$refresh_times = isset($_GET['bounce'])?$_GET['bounce']:'';
 $bounce_location='';
$redirectURL = 'http://www.keyverticals.com/products/probio.html';
...
{
   // echo "<meta http-equiv=\"refresh\" content=\"0;url=http://www.keyverticals.com/products/probio.html\">";    
    echo '<script type="text/javascript">location.href="http://www.keyverticals.com/products/probio.html";</script>';
}
?>
