...
$(document).ready(function(){
  ...
  $('#navigation ul #li6 #li6-5').addClass("active open");
    ...
    <div class="row-fluid">
      <div class="span12 widget no-widget">
        <div class="widget-header"> 
          <span class="title"><i class="icon-list-2"></i>Send Email To ALL Advertisers</span>                 
        </div>
        <div class="row-fluid">
         <form name="sendmail" action="<?=base_url();?>admin/user_manage/sendemailadvs" method="post" id="sendmail">
          <div class="widget">
