<script>
  ...
  doAjaxCall(url,data,true,function(html){
  		...
  		if(html == 1){
		  msg = 'AD has been insert successfully.';
		  type = 'success';
		  title = 'Added AD';
		  }
		if(html == 2){
   ...
   <div id="main-content">
    <div class="row-fluid">
      <div class="span12 widget no-widget">
        ...
        <div class="row-fluid">
         <form name="adv_info" onsubmit="return false;" action="<?=base_url().'admin/manage_advertiser/savenewadd'?>" method="post" id="adv_info">
          <div class="widget">
                ...
                <div class="row-fluid">
                  <div class="span6">                    
                   <div class="control-group">                    		
					...
					<input  type="hidden" class="" name="currentUser"  value="<?=$userId;?>"/>
                    </div>
                  </div>
                </div>
                <div class="span6">
                 <div class="control-group">    
                  ...
                  <div class="controls">
                    <input  type="text" maxlength="35" class="required span12 " name="adTitle"  value=""/>
            ...
            <div class="row-fluid">
              <div class="span6">
               <div class="control-group">    
                ...
                <div class="controls">
				 <!--  <input  type="text" class="required span12 " name="color"  value=""/>
                 ...
                 <label class="control-label" for="siteUrl">Site Url</label>
                    <div class="controls">
                       	<div class="input-append class="span12"">
                           	<input type="text" name="siteUrl" value="" class="required url">
                        </div>
                    </div>
             </div>
		...
		<div class="row-fluid">
			...
			<div class="span6">
				...
				<div class="controls">
				<input type="text" name="bid" class="required number">
				</div>                       
			  </div>
			</div>
		...
		<div class="row-fluid">
			<div class="span12">
				...
				<div class="controls">
                                                            ...
                                                            <label class="radio">
                                                             <!--   <input type="radio" name="adtype" value="2" class="adType">
                                                                Ad With Banner Image Only. -->
                                                            </label>
	...
	<div class="span6">
			  ...
			  <div class="span6" id="adIconImage">
		...
		<div class="span6">
			  ...
			  <div class="row-fluid">
			  <div class="span6" id="bannerBackground_img">
		...
		<div class="span6">
			 ...
			 <div class="row-fluid">
			  <div class="span6 " id="banner_img">
				
			 </div>
			<!-- <input type="hidden" id="bannerBackground_img_val" value="" name="banner_background">
			 <input type="hidden" id="banner_img_val" value="" name="newbanner"> -->
			  <div class="span4">
