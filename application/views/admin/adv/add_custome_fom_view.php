 ...
 /*end add function */
	...
	$("#formheader").off('click').on('click',function(){
		...
		$('#saveFomData1,#saveFomData2').click(function(){
			var url=$('#base_url').val()+"admin/customeform/saveform"	
			  $.msgbox("Insert your form name below :", {
				  type: "prompt"
				}, function(result) {
				  if (result) {
					var form_data  =  $('#Elements').html();
					var form_name= result;
					var data = 'form_name='+form_name+'&form_data='+form_data;
					 doAjaxCall(url,data,true,function(html){
    ...
    <div class="row-fluid">
      <div class="span12 widget no-widget">
        <div class="widget-header"> 
          <span class="title"><i class="icos-create"></i>Add New Customize Form</span>                 
  ...
  <ul id="secondryUl" class="displayNo">
				...
				<li rel="singleLine">
                	<div class="element_div">
						...
						<input type="hidden" name="sinleLine_label[]" value="Text">	
			...
			<div id="number">
                <li rel="number">
                	<div class="element_div">
                    	<label class="primary"> Number</label>
						<input type="hidden" name="number_label[]" value="Number">	
						<span class="helpMark" ></span>
                        <div class="medium c1" >
			...
			<div id="pText">
                <li rel="pText">
                	<div class="element_div">
                    	<label class="primary"> Paragraph</label>
						<input type="hidden" name="pText_label[]" value="Paragraph">	
						<span class="helpMark" ></span>
                        <div class="medium c1">
			...
			<div id="checkbox">	
                 <li rel="checkbox">
                	<div class="element_div">
                    	<label class="primary">Checkboxes</label>
						<input type="hidden" name="checkbox_label[]" value="Checkboxes">
						<span class="helpMark" ></span>
		...
		<div id="multipleChoice">				 
                <li rel="multipleChoice">
                	<div class="element_div">
	                       <label class="primary">Radio Button</label>
						   <input type="hidden" name="multipleChoice_label[]" value="Radio Button">
						   <span class="helpMark" ></span>
                        <div class="radio_div">
	                        <div>
            ...
            <div id="dropDown">    
                 <li rel="dropDown">
                	<div class="element_div">
                    	<label class="primary" for="dropDownList[]">Select Box</label>
						<input type="hidden" name="dropDown_label[]" value="Select Box">
						<span class="helpMark" ></span>
			...
			<div id="nameText">	
                <li rel="nameText">
                	<div class="element_div twoinputs">
						...
						<input type="hidden" name="nameText_label[]" value="Name">
						<span class="helpMark" ></span>
                        <div>
                            <span class="two">
							<div >
                ...
                <div id="dateText"> 
                 ...
                 <li rel="dateText">
                	<div class="element_div threeinputs">
                    	<label class="primary">Date</label>
						<input type="hidden" name="dateText_label[]" value="Date">
						<span class="helpMark" ></span>
                        <div>
                           	<span>
                            <div >
			...
			<div id="timeText">
                <li rel="timeText">
                	<div class="element_div fourinputs">
                    	<label class="primary">Time</label>
						<input type="hidden" name="timeText_label[]" value="Time">
						<span class="helpMark" ></span>
                        <div>
                           	<span>
                            <div >
			...
			<div id="phoneText">
                <li rel="phoneText">
                	<div class="element_div threeinputs">
						...
						<input type="hidden" name="phoneText_label[]" value="Phone">
						<span class="helpMark"></span>
                        <div class="tempStore">
                           	<span>
                            	<div >
			...
			<div id="addressText">	
                <li rel="addressText">
                	<div class="element_div">
                    	<label class="primary">Address</label>
						<input type="hidden" name="addressText_label[]" value="Address">
						<span class="helpMark" ></span>
						<div class="address">
                            <span>
                               <div >
			 ...
			 <div id="websiteText">
                <li rel="websiteText">
                	<div class="element_div">
                    	<label class="primary"> Website</label>
						<input type="hidden" name="websiteText_label[]" value="Website">
						<span class="helpMark" ></span>
                        <div>
                         <div class="medium c1" >
             ...
             <div id="priceText">
                <li rel="priceText">
                	<div class="element_div">
                    	<label class="primary">Price</label>
						<input type="hidden" name="priceText_label[]" value="Price">
						<span class="helpMark" ></span>
                        <div>
	                        <span>
			...
			<div id="emailText">
                 <li rel="emailText">
                	<div class="element_div">
                    	<label class="primary">Email</label>
						<input type="hidden" name="emailText_label[]" value="Email">
						<span class="helpMark" ></span>
						<div class="medium c1" >
            ...
            <div id="sectionBreak"> 
                <li rel="sectionBreak">
                	<div class="element_div">
                    	<div class="Break">
	                        <label class="primary">Section Break</label>
							<input type="hidden" name="sectionBreak_label[]" value="Section Break">
                        </div>
                   </div>
                   	<div class="dublicate"></div> 
                  	<div class="del_element"></div>
