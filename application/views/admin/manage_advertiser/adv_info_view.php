<script>
  ...
  var base = '<?=base_url()?>';
			...
			var url = base+'admin/manage_advertiser/resizing/'+adID+'/'+orignalSrc+'/'+field;
			var data = '';
			doAjaxCall(url,data,true,function(html){
   ...
   <div id="main-content">
    <div class="row-fluid">
      <div class="span12 widget no-widget">
        ...
        <div class="row-fluid">
         <form name="adv_info" onsubmit="return false;" action="<?=base_url().'admin/manage_advertiser/saveAdvInfo'?>" method="post" id="adv_info">
          <div class="widget">
              ...
              <div class=" form-horizontal remove-top-border">
                ...
                <div class="span6">
                 <div class="control-group">    
                  ...
                  <div class="controls">
                    <input  type="text" maxlength="35" class="required span12 " name="adTitle"  value="<?=$info->adTitle;?>"/>
                 ...
                 <label class="control-label" for="siteUrl">Site Url</label>
                    <div class="controls">
                       	<div class="input-append class="span12"">
                           	<input type="text" name="siteUrl" value="<?=$info->siteUrl;?>" ><a href="<?=$info->siteUrl;?>" target="_blank" title="go for link">	<button type="button" class="btn"><i class="icol-magnifier"></i></button>
											  </a>
                        </div>
                    </div>
             </div>
			...
			<div class="control-group">                                                
				...
				<div class="controls">
					<select name="state" class="span12">
						<option>--State--</option>
						<? foreach($states  as $ref){?>
						<option value="<?=$ref->stateId.'-'.$ref->stateName;?>"  <?=($info->state == $ref->stateId) ? 'selected':'';?>><?=$ref->stateName?></option>
						<?}?>
					</select>
		...
		<div class="row-fluid">
			...
			<div class="span6">
			   <div class="control-group">                                                
				<label class="control-label" >Admin Approvel</label>
				<div class="controls">
		...
		<div class="row-fluid small-bottom-space">
			...
			<div class="span6">
				...
				<div class="controls">
					<select name="form_name">
						<? foreach($forminfo as $ref){	?>
							<option value="<?=$ref->formId?>" <?=($ref->formId==$info->formId) ? 'selected':'';?>><?=$ref->formName;?></option>
						<?	}	?>
					</select>
				</div>                       
			  </div>
		...
		<fieldset>
			<legend> Choose Your Form Type</legend>
			<div class="control-group">                                                
                   <div class="control">                                                
			...
			<div class="span6">
			<div class="control-group">                                                
				<label class="control-label" >Ad Title (Display On Site) </label>
				<div class="controls">
						<input type="text" name="display_title" maxlength="35" class="span12 required" value="<?=$info->adTitle_display;?>" >
			...
			<div class="span6">
			   <div class="control-group">                                                
				<label class="control-label" >Ad Description  (Display On Site)</label>
				<div class="controls">
	...
	<div class="span3">
			  ...
			  <div class="span12" style="display: none" id="adIconImage">
      ...
      <div class="form-actions" >
	   ...
	   <div class="pull-right">
			...
			<a href="javascript:" class="btn btn-danger suspendMe" src="<?=base_url().'admin/adv_manage/adminadstatus/'.$info->adId.'/'.$info->isActive ;?>" name="<?=$info->adName;?>"> <?=($info->isActive == 0) ? 'Activate' : 'Suspend' ;?></a> 
			  <a class="btn btn-warning deleteMe" href="<?=base_url().'admin/adv_manage/admindeleteadv/'.$info->adId;?>" name="<?=$info->adName;?>">Delete</a>
...
<script type="text/javascript">
		...
		$(document).ready(function(){
				...
				$('#userfile').uploadify({
					...
					'uploader': base_url+'admin/manage_advertiser/do_upload/'+adId+'/'+2,
				...
				$('#userBanner').uploadify({
					...
					'auto':true,
					'swf': base_url+'assets/admin_property/bootstrap/js/jquery/uploadify_31/uploadify.swf',
					'uploader': base_url+'admin/manage_advertiser/do_upload/'+adId+'/'+1,
					'cancelImg': base_url+'assets/admin_property/bootstrap/js/jquery/uploadify_31/uploadify-cancel.png',
					'fileTypeExts':'*.jpg;*.bmp;*.png;*.tif;*.jpeg;*.gif',
					'fileTypeDesc':'Image Files (.jpg,.bmp,.png,.tif,.gif,.jpeg)',
					'fileSizeLimit':'2MB',
