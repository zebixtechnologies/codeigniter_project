...
$formxml=$formxml.'<vehiclemodel>'.$carmodel.'</vehiclemodel></vehicle>';
...
$formxml=$formxml.'<vehiclemodel>'.$this->security->xss_clean($this->input->post('car-model-select'.$vehiclecount)).'</vehiclemodel></vehicle>';
...
EOD;
    ...
    public function sendmailforleads($mails){
        ...
        require_once("mailer/Email.php");
        $emailSender = new Email();
        $emailSender->SendEmail('request_for_quotes',$mailData,$mails,ADMIN_MAIL,ADMIN_MAIL_PASSWORD,SITE_NAME,'Your Request for Quotes');
