...
<?// print_r($pubifo);?>
 ...
 <form class="form-horizontal" method="post" action="<?=base_url().'pub_loginuser/dashboard/updatecategory'?>" id="update_category" onsubmit="return true;">
       
                  
                <ul class=" gf-checkbox inline">
					<?php	 $ifon=explode('-' , $usercat->categoryId);
						$i=0;
