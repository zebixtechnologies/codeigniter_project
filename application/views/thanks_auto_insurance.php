        ...
        <div class="twelvecol">   
            ...
            <div class="thanks">
               ...
               <span class="generic_rate">
                  Below is the generic rate quote for <strong><?php echo isset($category->categoryName) ? $category->categoryName : ""; ?></strong> from 
                 <strong><?php echo $k;?></strong> going by the <br> information you provided (we'll let you know if you qualify for extra discounts).
