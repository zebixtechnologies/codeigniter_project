  ...
  <div class="row clearfix">
    <div class="twelvecol">   
        ...
        <?php 
            ...
            <?php  } ?>
          <div class="content">
              <span style="display:inline-block;margin-bottom:0px !important;line-height: 32px; margin-bottom: 0px;width:50%;box-sizing: border-box;margin: 40px 0px;font-family: verdana;font-weight: normal;font-size: 15px;color:#1f497d;">Helpful Agents are always standing by:<br/> 01-4540940, 08055970045.</span>
