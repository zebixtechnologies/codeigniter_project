      ...
      <div class="navbar-inner">
        <div class="container">
          <div class="brand-wrap pull-left">
            <div class="brand-img"> <a class="brand" href="<?php echo base_url();?>advertiser"> <img src="<?php echo base_url().'assets/admin_property/assets/';?>images/logo.png" alt="" style="width: 180px; "> </a> </div>
          </div>
            ...
            <div id="header-functions" class="pull-right">
             ...
             <div class="avatar">
               ...
               <ul class="dropdown-menu pull-right">
                 <li><a href="<?php echo base_url();?>adv_loginuser/dashboard/profileinfo"><i class="icol-user"></i> My Profile</a></li>
      ...
      <div id="content-inner">
        <aside id="sidebar">
          <nav id="navigation" class="collapse">
            <ul>
              <li id="li1"> <a href="<?php echo base_url();?>advertiser"><span title="Dashboard"> <i class="icon-home"></i> <span class="nav-title">Home</span> </span> </a></li>
             <!--<li id="li2"> <a href="<?=base_url().'adv_loginuser/dashboard/adinfo'?>"><span title="system"> <i class="icon-table"></i> <span class="nav-title">Manage Ad</span> </span></a></li>-->
              <!--<li id="li2"> <a href="<?php echo base_url();?>adv_loginuser/dashboard/category"><span title="Advertise Activity"> <i class="icon-graph"></i> <span class="nav-title">Categories</span> </span> </a></li>-->
         <? /*         <li id="li2-2"><a href="#"><i class="icol-hammer-screwdriver"></i> Driver Listing</a></li>
                  <li id="li2-3"><a href="#"><i class="icol-table"></i> Customer Listing</a></li>
               ...
               <li id="li2"> <span title="system"> <i class="icon-table"></i> <span class="nav-title">Leads Report</span> </span>
              <ul class="inner-nav">
                 
              <li id="li2-1"> <a href="<?=base_url().'adv_loginuser/dashboard/report'?>"><i class="icol-hammer-screwdriver"></i>Your Leads
               </a>
              </li>
                   <li id="li2-2"> <a href="<?=base_url().'adv_loginuser/dashboard/leadsformview'?>"><i class="icol-hammer-screwdriver"></i>Total Form Views
               </a>
              </li>
              <li id="li2-3"> <a href="<?=base_url().'adv_loginuser/dashboard/leadquotes'?>"><i class="icol-hammer-screwdriver"></i>Lead Quotes
               </a>
              </li>
			  ...
			  <li id="li6"> <a href="<?=base_url().'adv_loginuser/dashboard/purchaselead'?>"><span title="Earn Leads"> <i class="icon-html5"></i> <span class="nav-title">Buy Old Leads</span> </span>
               </a>
              </li>
             <li id="li7"> <a href="<?=base_url().'adv_loginuser/dashboard/pauseview'?>"><span title="Earn Leads"> <i class="icon-html5"></i> <span class="nav-title">Pause Leads</span> </span>
               </a>
              </li>
